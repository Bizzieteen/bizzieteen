    ...
    $('#mc-form').ajaxChimp({
        ...
        callback: function callbackFunction(resp) {
            ...
            if (resp.result === 'success') {
                // Do stuff
                $('#mc-notification').html('<i class="fa fa-envelope"></i> Awesome! We have sent you a confirmation email')
            }
        },
        url: 'http://bizzieteen.us14.list-manage.com/subscribe/post?u=db5162412ad739b254b836fcc&amp;id=dbbd0c2a06'
